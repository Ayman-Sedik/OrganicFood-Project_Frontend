...
import style from './AddInP1.module.css'
export default function AddInP1() {
    ...
    const addNewProduct = (e) => {
        ...
        dispatch(addVegetables(formValue)).then(navigate('/vegetables')).catch((err) => { })

    }
    const editeProduct = (e) => {
        e.preventDefault()
        console.log(formValue)
        dispatch(editeVegetables({ id, formValue })).then(navigate('/vegetables')).catch((err) => { })
