...
import { addHerbals, editeHerbals } from '../../../../Store/slices/ApiHerbals';

import style from './AddHerbals.module.css'
export default function AddInHerbals() {
    ...
    const addNewProduct = (e) => {
        ...
        dispatch(addHerbals(formValue)).then(navigate('/herbals')).catch((err) => { })

    }
    const editeProduct = (e) => {
        e.preventDefault()
        console.log(formValue)
        dispatch(editeHerbals({ id, formValue })).then(navigate('/herbals')).catch((err) => { })
    ...
    let { edited } = useSelector((state) => state.herbalsSlice)
