...
import { addMeat, editeMeat } from '../../../../Store/slices/ApiMeat';
import style from './AddMeat.module.css'
export default function AddInMeat() {
    ...
    const addNewProduct = (e) => {
        ...
        dispatch(addMeat(formValue)).then(navigate('/meat')).catch((err) => { })

    }
    const editeProduct = (e) => {
        e.preventDefault()
        console.log(formValue)
        dispatch(editeMeat({ id, formValue })).then(navigate('/meat')).catch((err) => { })
    ...
    let { edited } = useSelector((state) => state.meatSlice)
