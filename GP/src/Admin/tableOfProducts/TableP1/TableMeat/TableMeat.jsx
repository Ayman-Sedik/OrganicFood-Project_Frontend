...
import { deleteMeat, getMeat } from '../../../../Store/slices/ApiMeat'
import style from './TableMeat.module.css'
export default function TableMeat() {
    ...
    return (
        <>
            <div class=" ">
                ...
                <button onClick={() => { navigate('/admin/addInMeat') }} className='btn btn-primary btn-lg m-2 '><i class="fa-solid fa-plus"></i></button>
                </div>
                <div className="">
                <h2 className='text-center fs-1 text-muted py-2'>Meat</h2>
                                    ...
                                    (product, index) => {
                                        return (<tr className='fw-semibold text-muted ' key={product._id}>
                                            ...
                                            <td className={` fs-1  border p-0 w-25  `}>
                                                <button class="btn btn-secondary mx-1 fs-5" onClick={() => { navigate(`/admin/detailsMeat/${product._id}`) }}  ><i class="fa-solid fa-circle-info"></i></button>
                                                <button class="btn btn-warning mx-1 fs-5" onClick={() => { navigate(`/admin/addInMeat/${product._id}`) }} ><i class="fa-solid fa-pen-to-square"></i></button>
